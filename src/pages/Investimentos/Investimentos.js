    ...
    <ImageBackground source={require(bgimage)} style={styles.bgimage}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.investimento}>
          ...
          >
            <Text style={{ color: '#FFF', top: 7, textAlign: 'center' }}>
              R$
            </Text>
            <Text
              style={{
          ...
          <View style={styles.goldView}>
            ...
            >
              {' '}
              Acompanhe o Mercado em Ouro{' '}
            </Text>
            <TouchableOpacity onPress={() => ourin()}>
              <Image source={goldlink} style={styles.goldimg} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => ourin()}>
              <Text
                style={{
              ...
              >
                XAUUSD - Gráfico e Preço do Ouro
              </Text>
              <Text
                style={{
                  color: '#FFF',
