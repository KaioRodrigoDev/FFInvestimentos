  ...
  function Users({ nome, cpf, id }) {
    return (
      <View style={styles.item}>
        <View style={{ flex: 1 }}>
          <Text
            style={{ color: '#FFF', fontSize: 20, fontFamily: 'monte-serrat' }}
          >
            {nome}{' '}
          </Text>
          <Text
            style={{ color: '#FFF', fontSize: 16, fontFamily: 'monte-serrat' }}
          >
            CPF: {cpf}
          </Text>
        </View>
        ...
        <View style={{ justifyContent: 'center', flexDirection: 'row' }}>
          ...
          <TouchableOpacity
            ...
            style={{ justifyContent: 'center', paddingRight: 10 }}
          >
            <Feather name={'user-minus'} size={30} color={'#FFF'} />
          </TouchableOpacity>
          ...
          >
            <FontAwesome name={'remove'} size={30} color={'#FFF'} />
          </TouchableOpacity>
        </View>
      </View>
    )
      ...
      <KeyboardAvoidingView style={{ flex: 1 }}>
        ...
        <View style={{ flex: 1, justifyContent: 'center' }}>
          <FlatList
            ...
            renderItem={({ item }) => (
              <Users nome={item.name} cpf={item.cpf} id={item.id} />
            )}
          />
        </View>
      </KeyboardAvoidingView>
